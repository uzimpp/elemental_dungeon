"""
Configuration settings for the Incantato game.
Contains constants for screen dimensions, colors, game balance,
player and enemy attributes, file paths, and UI settings.
"""
...
class Config:
    ...
    P_BASE_HP = 100
    E_BASE_HP = 50
    P_BASE_SPEED = 60  # 1 * 60
    P_SPRINT_SPEED = 180  # 3.0 * 60
    E_BASE_SPEED = 105  # 1.75 * 60
    SPRITE_SIZE = 32
    ...
    P_DASH_COST = 50
    P_DASH_DISTANCE = 100
    P_STAMINA_COOLDOWN = 2.5  # Cooldown period in seconds
    P_RADIUS = RENDER_SIZE / 3
    P_MAX_HEALTH = 100
    P_SUMMON_LIMIT = 5
    P_SPRITE_PATH = "assets/sprites/player_sheet.png"

    # Enemy configuration
    E_BASE_HP = 50
    E_BASE_SPEED = 105  # 1.75 * 60
    E_DAMAGE = 5
    E_RADIUS = RENDER_SIZE / 3
    E_SPRITE_PATH = "assets/sprites/enemy_sheet.png"
